...
class FoundationPose:
  ...
  def register(self, K, rgb, depth, ob_mask, ob_id=None, glctx=None, iteration=5):
    ...
    '''
    print("estimator::register called")
    set_seed(0)
    logging.info('Welcome')

    # print(f"estimator::register::K::{K}")
    # print(f"estimator::register::rgb::{rgb}")
    # print(f"estimator::register::depth::{depth}")
    # print(f"estimator::register::ob_mask::{ob_mask}")

    # Save to .npy file
    # np.save('register_K.npy', K)
    # np.save('register_rgb.npy', rgb)
    # np.save('register_depth.npy', depth)
    # np.save('register_ob_mask.npy', ob_mask)
    ...
    # Plot the expected depth
    axes[0].imshow(depth, cmap='gray')
    axes[0].set_title('estimator Depth')
    ...
    # Save the figure
    output_file = 'publisher_comparison.png'
    ...
    print("estimator::register::ended")
